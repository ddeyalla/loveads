...
export default function Home() {
  ...
  // Function to highlight links in the text
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-300 via-teal-200 to-purple-300">
      <div className="container mx-auto px-4 py-6">
        ...
        {/* Main Content */}
        <main className="flex flex-col items-center justify-center mt-48 max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="self-stretch w-full relative">
                <textarea
                  ...
                  className="w-full resize-none overflow-hidden text-base font-normal leading-normal bg-transparent outline-none min-h-[24px] text-gray-900 placeholder:text-gray-500"
                  rows={1}
                />

                {/* Link highlighting overlay */}
                {inputValue && (
                  <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-0" aria-hidden="true">
                    {highlightLinks(inputValue)}
                  </div>
                )}
              </div>
